...
(function($){
	var methods={
		...
		update:function(options){
			...
			var decodedTitle = decodeHtmlEntities(decodeHtmlEntities(options.title));
			$this.stop().css({"display":"none","z-index":$this.data("smt-z-index")}).children("div").text(decodedTitle);
